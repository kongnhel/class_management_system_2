                    ...
                    <div class="border-t border-gray-200/50 pt-8 mt-8">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div class="relative col-span-1 md:col-span-2">
                                        <x-input-label for="password"
                                            class="flex items-center text-lg text-gray-700 font-semibold mb-2">
                                        ...
                                        <button type="button" id="togglePassword"
                                            class="absolute inset-y-0 right-4 flex items-center text-gray-400 hover:text-white focus:outline-none">
                                            <i class="fa-solid fa-eye"></i>
                                        </button>
                                    </div>
                                    {{-- <div>
                                        <x-input-label for="password" class="flex items-center text-lg text-gray-700 font-semibold mb-2"><i class="fas fa-lock mr-3 text-green-500"></i> {{ __('ពាក្យសម្ងាត់') }}</x-input-label>
                                        <x-text-input id="password" class="block w-full rounded-xl py-3 px-4" type="password" name="password" required autocomplete="new-password" />
                                        <x-input-error :messages="$errors->get('password')" class="mt-2" />
                                    </div> --}}
                                    <div class="relative col-span-1 md:col-span-2">
                        ...
                        <template x-if="userRole === 'student'">
                            <div class="space-y-6">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        <x-input-label for="student_id_code" class="flex items-center text-lg text-gray-700 font-semibold mb-2"><i class="fas fa-id-card mr-3 text-green-500"></i> {{ __('លេខកូដអត្តសញ្ញាណសិស្ស(អត្តលេខ )') }}</x-input-label>
                                    ...
                                    <div>
                                        ...
                                        <x-input-error :messages="$errors->get('program_id')" class="mt-2" />
                                           ...
                                           <div>
                                <x-input-label for="generation" class="flex items-center text-lg text-gray-700 font-semibold mb-2">
                                    <i class="fas fa-graduation-cap mr-3 text-green-500"></i> {{ __('ជំនាន់') }}
                                </x-input-label>
                                <x-text-input id="generation" class="block w-full rounded-xl py-3 px-4" type="number" name="generation" :value="old('generation')" required autocomplete="off" placeholder="ឧទាហរណ៍៖ 16"/>
